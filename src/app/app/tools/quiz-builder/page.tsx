...
const DIFFICULTIES = [
  ...
  "Mixed — range of difficulty levels",
];
...
export default function QuizBuilderPage() {
  ...
  const generate = useCallback(
    async (overrideParams?: Partial<FormState>) => {
      ...
      try {
        const response = await fetch("/api/ai/quiz-builder", {
          method: "POST",
  ...
  const handleRefine = useCallback(
    async (instruction: string) => {
      ...
      try {
        ...
        if (!response.ok) {
          throw new Error(data.error ?? "Failed to refine quiz");
        }
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-charcoal-light">
              Create a ready-to-use quiz with multiple question types and an answer key
            </p>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div>
                  <div className="flex items-center gap-1.5 mb-1.5">
                    ...
                    <HelpTooltip text="What subject or topic will this quiz assess? Be specific for best results." />
                  </div>
                  <input
                    type="text"
                    value={form.topic}
                    onChange={(e) => updateField("topic", e.target.value)}
                    placeholder="e.g. Photosynthesis, Fractions, Shakespeare's Hamlet..."
                    className={cn(
                ...
                <Select
                  ...
                  helpText="Select the year group or age range for this quiz."
                />
                ...
                <Select
                  ...
                  onChange={(v) => updateField("question_count", v)}
                  helpText="How many questions should the quiz contain?"
                />
                ...
                <MultiSelect
                  ...
                  onChange={(v) => updateField("question_types", v)}
                  helpText="What types of questions should be included? Select at least one."
                />
                ...
                <Select
                  ...
                  helpText="What difficulty level should the questions target?"
                />
                ...
                {!isFormValid && (
                  <p className="text-xs text-charcoal-light text-center">
                    Please fill in Topic, Grade Level, Question Count, Question Types, and Difficulty.
                  </p>
                )}
              </form>
            </CardContent>
          ...
          {result.loading && (
            <Card variant="default" padding="lg">
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-charcoal font-medium mb-1">Generating your quiz...</p>
              ...
              <div className="border-t border-border mt-6 pt-6">
                ...
                <div className="flex flex-wrap gap-3">
                  <Button
                    variant="secondary"
                    size="sm"
                    onClick={() => handleRefine("Make this quiz simpler — reduce the difficulty and add more recall-level questions.")}
                  ...
                  <Button
                    variant="secondary"
                    size="sm"
                    onClick={() => handleRefine("Add more detail to this quiz. Include more challenging questions and add marking guidance.")}
                    disabled={result.loading}
                  >
            ...
            <Card variant="default" padding="lg">
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <div className="w-16 h-16 bg-ivory rounded-full flex items-center justify-center mb-4">
                  <ClipboardCheck className="w-8 h-8 text-charcoal-light" />
                </div>
                ...
                <p className="text-sm text-charcoal-light max-w-sm">
                  Fill in the details on the left and click "Generate Quiz" to create a complete quiz with an answer key.
                </p>
              </div>
            </Card>
          )}
